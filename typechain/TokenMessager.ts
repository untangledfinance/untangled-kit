...
export interface TokenMessagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "addLocalMinter"
...
export interface TokenMessager extends BaseContract {
  connect(runner?: ContractRunner | null): TokenMessager;
  waitForDeployment(): Promise<this>;

  interface: TokenMessagerInterface;
