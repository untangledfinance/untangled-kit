...
export namespace UpdateLostAssetsEvent {
  export type InputTuple = [newLostAssets: BigNumberish];
  export type OutputTuple = [newLostAssets: bigint];
  export interface OutputObject {
    newLostAssets: bigint;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
  export type Filter = TypedDeferredTopicFilter<Event>;
  export type Log = TypedEventLog<Event>;
...
export interface MetaMorpho extends BaseContract {
  ...
  >;
  getEvent(
    key: "UpdateLostAssets"
  ): TypedContractEvent<
    UpdateLostAssetsEvent.InputTuple,
    UpdateLostAssetsEvent.OutputTuple,
    UpdateLostAssetsEvent.OutputObject
  >;
  getEvent(
    key: "Withdraw"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "UpdateLostAssets(uint256)": TypedContractEvent<
      UpdateLostAssetsEvent.InputTuple,
      UpdateLostAssetsEvent.OutputTuple,
      UpdateLostAssetsEvent.OutputObject
    >;
    UpdateLostAssets: TypedContractEvent<
      UpdateLostAssetsEvent.InputTuple,
      UpdateLostAssetsEvent.OutputTuple,
      UpdateLostAssetsEvent.OutputObject
    >;
