...
import type { TokenMessager, TokenMessagerInterface } from "../TokenMessager";
...
export class TokenMessager__factory {
  static readonly abi = _abi;
  static createInterface(): TokenMessagerInterface {
    return new Interface(_abi) as TokenMessagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): TokenMessager {
    return new Contract(address, _abi, runner) as unknown as TokenMessager;
  }
}
