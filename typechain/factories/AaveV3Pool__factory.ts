...
export class AaveV3Pool__factory {
  ...
  static createInterface(): AaveV3PoolInterface {
    return new Interface(_abi) as AaveV3PoolInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): AaveV3Pool {
    return new Contract(address, _abi, runner) as unknown as AaveV3Pool;
  }
}
