...
import type { PendleRouter, PendleRouterInterface } from "../PendleRouter";
...
export class PendleRouter__factory {
  static readonly abi = _abi;
  static createInterface(): PendleRouterInterface {
    return new Interface(_abi) as PendleRouterInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): PendleRouter {
    return new Contract(address, _abi, runner) as unknown as PendleRouter;
  }
}
